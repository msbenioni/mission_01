...
const KART_CATEGORIES: KartCategory = {
  standard: ['DS_Standard', 'MK7_MK8_Standard', 'Classic_Dragster', 'Tiny_Titan', 'Honey_Coupe', 'Booster_Seat', 'Cheep_Charge', 'Daytripper'],
  performance: ['Turbo', 'Super_Blooper', 'B_Dasher', 'B_Dasher_MK2', 'Sprinter', 'Falcon', 'Pipe_Frame'],
  special: ['Wild_Wing', 'Flame_Flyer', 'Jetsetter', 'Prowler', 'Falcon', 'Offroader', 'Mini_Beast']
};
